    ...
    <div class="container">
      <div class="row text-center text-xs-center text-sm-left text-md-left">
        ...
        <div class="col-xs-12 col-sm-4 col-md-4">
          ...
          <ul class="list-unstyled quick-links">
            ...
            <li><a href="javascript:void();"><i class="fa fa-angle-double-right"></i>Contact</a></li>
            <li><a href="javascript:void();"><i class="fa fa-angle-double-right"></i>Products</a></li>
            <li><a href="javascript:void();"><i class="fa fa-angle-double-right"></i>Checkout</a></li></ul>
        </div>
      </div>
      <div class="row">
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center text-white">
          <p><u><a href="www.google.com">This a blank company and blank pages with blank mind</a></u> this is registered by FIA</p>
          <p class="h6">&copy All right Reversed.<a class="text-green ml-2" target="_blank">BioAnalysis</a></p>
        </div>
        <hr />
      </div>
    </div>
